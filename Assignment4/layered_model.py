...
def fit_mnist_model_single_digit(x_train, y_train, target_digit, model: models.Sequential, epochs=10, batch_size=128):
...
def evaluate_mnist_model_single_digit(x_test, y_test, target_digit, model: models.Sequential):
